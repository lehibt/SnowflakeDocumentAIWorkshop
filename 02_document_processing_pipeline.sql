...
WHEN NOT MATCHED THEN INSERT
    (FILE_NAME, FILE_SIZE, APPLICATION_NUMBER, APPLICATION_NUMBER_SCORE, INVENTION_TITLE, INVENTION_TITLE_SCORE, INVENTOR, FILING_DT, RECEIPT_DTTM, N_DOCUMENTS, inserted_dttm)
    VALUES 
    (vph.FILE_NAME, vph.FILE_SIZE, vph.APPLICATION_NUMBER, vph.APPLICATION_NUMBER_SCORE, vph.INVENTION_TITLE, vph.INVENTION_TITLE_SCORE, vph.INVENTOR, vph.FILING_DT, vph.RECEIPT_DTTM, vph.N_DOCUMENTS, current_timestamp())
    ;
